...
<html lang="en">
  <head>
    ...
    <title>Nick Hlado Concept Artist</title>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li <?php if ($page == "contact") {echo 'class="active"';} ?>><a href="contact.php"> <span class="glyphicon glyphicon-phone"></span> Contact</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div> <!-- container -->
      </div> <!-- navbar -->
